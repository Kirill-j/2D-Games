...

{
	...
	if (!this->font.loadFromFile("Fonts/PixelLettersFull.ttf"))
		std::cout << "ERROR::GAME::INITGUI::Fail to load font" << "\n";

	// Init point text
	this->pointText.setFont(this->font);
	this->pointText.setCharacterSize(20);
	this->pointText.setFillColor(sf::Color::White);
	this->pointText.setPosition(sf::Vector2f(10.f, 0.f));
	...
	this->playerHpBar.setFillColor(sf::Color(255, 0, 0, 150));
	this->playerHpBar.setPosition(sf::Vector2f(10.f, 25.f));

	this->playerHpBarBack = this->playerHpBar;
	this->playerHpBarBack.setFillColor(sf::Color(25, 25, 25, 200));
	this->playerHpBarBack.setOutlineThickness(1);
...
void Game::initWorld()
{
	if (!this->worldBackgroundTex.loadFromFile("Textures/background.jpg"))
		std::cout << "ERROR::GAME::INITWORLD::Fail to load texture" << "\n";
